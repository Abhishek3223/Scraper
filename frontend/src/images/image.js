...
const Home = () => (
    <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="white">
...
const Menue = () => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnssvgjs="http://svgjs.com/svgjs" xmlnsxlink="http://www.w3.org/1999/xlink" width="40px" height="40px"><svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 16.933 16.933"><path fill="#fff" d="M12.271 1.323H1.984c-1.1-.042-1.1 1.63 0 1.588H12.23c1.08.042 1.122-1.588.042-1.588zM1.984 7.673c-1.058 0-1.058 1.587 0 1.587h5.8c1.08 0 1.08-1.587 0-1.587zm0 6.35c-1.058 0-1.058 1.587 0 1.587h12.997c1.058 0 1.058-1.587 0-1.587z" className="color000 svgShape" /></svg></svg>

)
const Cross = () => (
    <svg width="40px" height="40px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9.172 16.242 12 13.414l2.828 2.828 1.414-1.414L13.414 12l2.828-2.828-1.414-1.414L12 10.586 9.172 7.758 7.758 9.172 10.586 12l-2.828 2.828z" /><path d="M12 22c5.514 0 10-4.486 10-10S17.514 2 12 2 2 6.486 2 12s4.486 10 10 10zm0-18c4.411 0 8 3.589 8 8s-3.589 8-8 8-8-3.589-8-8 3.589-8 8-8z" /></svg>
)

const Mail = () => (
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <defs>
            <style>{`.cls-1{fill:#828687;}.cls-2{fill:#000000;}.cls-3{fill:#a6bbbf;}`}</style>
        </defs>
        <title>speech-bubble-9-flat</title>
        <path className="cls-1" d="M371.2,38.11H64a64,64,0,0,0-64,64V379.16C0,395,19.16,403,30.37,391.74L76.8,345.31H371.2a64,64,0,0,0,64-64V102.11A64,64,0,0,0,371.2,38.11Z" /><path className="cls-2" d="M243.2,191.71H448a64,64,0,0,1,64,64V456.06c0,15.86-19.18,23.79-30.38,12.57L435.2,422.11h-192a64,64,0,0,1-64-64V255.71A64,64,0,0,1,243.2,191.71Z" /><circle className="cls-3" cx="384" cy="306.91" r="12.8" /><circle className="cls-3" cx="345.6" cy="306.91" r="12.8" /><circle className="cls-3" cx="307.2" cy="306.91" r="12.8" /></svg>
)
const Verify = () => {
    // <svg
    //     width={800}
...
//     <svg width="24px" height="24px" viewBox="0 0 512 512" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
//         <path d="M297.2,478l20.7-21.6L108.7,256L317.9,55.6L297.2,34L65.5,256L297.2,478z M194.1,256L425.8,34l20.7,21.6L237.3,256  l209.2,200.4L425.8,478L194.1,256z" /></svg>


// )

export { Home, Logo, Menue, Cross, Mail, DashboardImage, Verify };